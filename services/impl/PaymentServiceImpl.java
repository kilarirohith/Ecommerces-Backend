    ...
    import com.Kilari.repository.PaymentOrderRepository;

    import com.Kilari.services.PaymentService;
    ...
    public class PaymentServiceImpl implements PaymentService {
        ...
        public PaymentLink createRazorPayPaymentLink(User user, Long amount, Long orderId) throws RazorpayException {
            ...
            try{
                ...
                paymentLinkRequest.put("callback_url","http//localhost:1919/payment-success/"+orderId);
        ...
        public String createStripePaymentLink(User user, Long amount, Long orderId) throws StripeException {
            ...
            SessionCreateParams params = SessionCreateParams.builder()
                    ...
                    .setSuccessUrl("http://localhost:1919/payment-success"+orderId)
                    .setCancelUrl("http://localhost:1919/payment-cancel")
                    .addLineItem(SessionCreateParams.LineItem.builder()
                            ...
                            .setPriceData(SessionCreateParams.LineItem.PriceData.builder()
                                    ...
                                    .setProductData(
                                            SessionCreateParams.LineItem.PriceData.ProductData.builder().setName("KILARI ROHITH BAZAR PAYMENTS")
                                                    .build()
                                    ).build()
                            ).build()
                    ).build();
